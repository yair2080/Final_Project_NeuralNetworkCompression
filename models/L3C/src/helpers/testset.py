...
class Testset(object):
    ...
    def __init__(self, root_dir_or_img, max_imgs=None, skip_hidden=False, append_id=None):
        ...
        #Jonathan: we are going to send a list:
        if(type(root_dir_or_img)==list):
            root_dir = root_dir_or_img
            self.ps =root_dir_or_img
            self.name = "Multiple Files Test"
        ...
        elif os.path.isdir(root_dir_or_img):
            root_dir = root_dir_or_img
